#!/bin/bash
# RenMakesStuff	    https://www.youtube.com/@RenMakesStuff      # UC8_bu13DAsoqHiqQMhZcYgw
NAME="RenStuff"
FEED="https://www.youtube.com/feeds/videos.xml?channel_id=UC8_bu13DAsoqHiqQMhZcYgw"
