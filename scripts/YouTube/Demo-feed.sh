#!/bin/bash
# DemolitionRanch	https://www.youtube.com/@DemolitionRanch ID: UCBvc7pmUp9wiZIFOXEp1sCg
NAME="Demo"
FEED="https://www.youtube.com/feeds/videos.xml?channel_id=UCBvc7pmUp9wiZIFOXEp1sCg"
